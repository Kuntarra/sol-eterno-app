  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="font-display text-2xl font-semibold text-[var(--ink)] tracking-[-0.01em]">Flota</h1>
      ...
      <div className="bg-[var(--surface)] rounded-xl border border-[var(--gray-200)] p-6 mb-8">
        <h2 className="text-sm font-semibold text-[var(--ink)] mb-4">Agregar vehículo</h2>
        <VehiculoForm />
      </div>
            ...
            <tbody>
              {vehiculos.map((v) => (
                <tr key={v.id} className="border-b border-[var(--gray-100)] last:border-0">
                  <td className="px-5 py-3.5 font-medium text-[var(--ink)]">{TIPO_VEHICULO_LABEL[v.tipo] ?? v.tipo}</td>
