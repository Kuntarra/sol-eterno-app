  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="font-display text-2xl font-semibold text-[var(--navy)] tracking-[-0.01em]">Importar personal desde Excel</h1>
      ...
      <div className="bg-white rounded-xl border border-[var(--gray-200)] p-6 mb-6">
        <h2 className="text-sm font-semibold text-[var(--navy)] mb-3">Cómo funciona</h2>
        ...
        <div className="mt-4 rounded-lg bg-[var(--gray-100)] p-4 text-xs text-[var(--gray-600)]">
          <p className="font-semibold text-[var(--navy)] mb-1.5">Columnas reconocidas</p>
        ...
        <a href="/api/personal/plantilla"
           className="inline-flex items-center gap-2 mt-4 px-4 py-2.5 rounded-lg bg-white border border-[var(--gray-200)] text-[var(--navy)] text-sm font-semibold hover:bg-[var(--gray-100)] transition-colors">
      ...
      {/* Subida */}
      <form action={importPersonas} className="bg-white rounded-xl border border-[var(--gray-200)] p-6">
        <h2 className="text-sm font-semibold text-[var(--navy)] mb-4">Subir archivo</h2>
